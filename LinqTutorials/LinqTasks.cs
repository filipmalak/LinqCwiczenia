...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<Emp> result = from obj in Emps
                where obj.Job == "Backend programmer"
                select obj;
        ...
        {
            IEnumerable<Emp> result = from obj in Emps
                where obj.Job == "Frontend programmer"
                      && obj.Salary > 1000
                orderby obj.Ename descending
                select obj;
            return result;
        }
        ...
        {
            IEnumerable<Emp> result = from obj in Emps
                where obj.Salary == Emps.Max(obj => obj.Salary)
                select obj;
            return result;
        }
        ...
        public static IEnumerable<object> Task10()
        {
            ...
            var result = empQuery.Concat(nullQuery);
        ...
        {
            IEnumerable<Emp> result = Emps.EmployeesWithDirectSubordinates();
            return result;
        }
    ...
    public static class CustomExtensionMethods
    {
        ...
        public static IEnumerable<Emp> EmployeesWithDirectSubordinates(this IEnumerable<Emp> employees)
        {
            var result = employees.Where(emp => employees.Any(sub => sub.Mgr != null && sub.Mgr.Empno == emp.Empno))
